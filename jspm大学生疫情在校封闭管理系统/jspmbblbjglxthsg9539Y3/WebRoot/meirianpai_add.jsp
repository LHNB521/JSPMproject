...
function gow()
{
	document.location.href="meirianpai_add.jsp?id=<%=id%>";
}
...
new CommDAO().insert(request,response,"meirianpai",ext,true,false,""); 
