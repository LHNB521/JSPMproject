...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc" >  
 ...
 <% 
    ...
    String url = "meirianpai_list3.jsp?1=1"; 
    String sql =  "select * from meirianpai where jiaoshigonghao='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("yuanxi")=="" ||request.getParameter("yuanxi")==null ){}else{sql=sql+" and yuanxi like '%"+request.getParameter("yuanxi")+"%'";}
 ...
 <td><%=map.get("jiaoshigonghao") %></td>
    ...
    <td width="220" align="center"> <a class="btn btn-info btn-small" href="meirianpai_list3.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a class="btn btn-info btn-small" href="meirianpai_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
