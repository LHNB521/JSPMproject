...
<link rel="stylesheet" href="images/hsgcommon/div.css" type="text/css">
  ...
  <form name="form1" id="form1" method="post" action="">
   搜索:  学号：<input name="xuehao" type="text" id="xuehao" class="form-control2" />  学生姓名：<input name="xueshengxingming" type="text" id="xueshengxingming" class="form-control2" />
   <input type="submit" name="Submit" value="查找" class="btn btn-info btn-small" /> <input type="button" name="Submit2" value="导出EXCEL" class="btn btn-info btn-small" onClick="javascript:location.href='xueshengkaoqin_listxls.jsp';" />
</form>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc" >  
  ...
  <% 
  	 ...
  	 new CommDAO().delete(request,"xueshengkaoqin"); 
  ...
  <tr>
    ...
    <td width="220" align="center"><a class="btn btn-info btn-small" href="xueshengkaoqin_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a class="btn btn-info btn-small" href="xueshengkaoqin_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a>  </td>
  </tr>
  	<%
  }
   %>
