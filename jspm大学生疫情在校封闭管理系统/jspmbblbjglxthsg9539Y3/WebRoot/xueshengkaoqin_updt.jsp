...
new CommDAO().update(request,response,"xueshengkaoqin",ext,true,false,""); 
HashMap mmm = new CommDAO().getmap(id,"xueshengkaoqin"); 

%>
  <form  action="xueshengkaoqin_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改学生考勤:
  <br><br>
